...
export default function Privacy() {
  ...
  return (
    <div className="p-4">
      ...
      <div lang="de">
        <p>
          Wir freuen uns sehr über Ihr Interesse. Datenschutz hat einen
          besonders hohen Stellenwert für mwauth. Eine Nutzung der
          Internetseiten von mwauth ist grundsätzlich ohne jede Angabe
          personenbezogener Daten möglich. Sofern eine betroffene Person
          besondere Services von mwauth über unsere Internetseite in Anspruch
        ...
        <p>
          ...
          und in Übereinstimmung mit den für mwauth geltenden landesspezifischen
          Datenschutzbestimmungen. Mittels dieser Datenschutzerklärung möchte
          mwauth die Öffentlichkeit über Art, Umfang und Zweck der von uns
        ...
        <p>
          mwauth hat als für die Verarbeitung Verantwortlicher zahlreiche
        ...
        <p>
          Die Datenschutzerklärung von mwauth beruht auf den Begrifflichkeiten,
        ...
        <h2>2. Name des für die Verarbeitung Verantwortlichen</h2>
        <p>
        ...
        <p>mwauth</p>
        <p>E-Mail: hello@melvinweiershaeuser.de</p>
        <p>Website: https://auth.melvinweiershaeuser.de</p>

        <h2>3. Cookies</h2>
        <p>
          Die Internetseiten von mwauth verwenden Cookies. Cookies sind
        ...
        <p>
          Durch den Einsatz von Cookies kann mwauth den Nutzern dieser
        ...
        <p>
          Die Internetseite von mwauth erfasst mit jedem Aufruf der
        ...
        <p>
          ...
          mwauth keine Rückschlüsse auf die betroffene Person. Diese
          ...
          anonym erhobenen Daten und Informationen werden durch mwauth daher
          einerseits statistisch und ferner mit dem Ziel ausgewertet, den
          Datenschutz und die Datensicherheit bei mwauth zu erhöhen, um
        ...
        <ul className="list-none">
          ...
          <li>
            ...
            <p>
              ...
              bei mwauth gespeichert sind, veranlassen möchte, kann sie sich
              hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
              Verantwortlichen wenden. Der Mitarbeiter von mwauth wird
              veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
              wird.
            </p>

            <p>
              Wurden die personenbezogenen Daten von mwauth öffentlich gemacht
              und ist mwauth als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO
              zur Löschung der personenbezogenen Daten verpflichtet, so trifft
              mwauth unter Berücksichtigung der verfügbaren Technologie und der
              ...
              von mwauth wird im Einzelfall das Notwendige veranlassen.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              Daten, die bei mwauth gespeichert sind, verlangen möchte, kann sie
              sich hierzu jederzeit an einen Mitarbeiter des für die
              Verarbeitung Verantwortlichen wenden. Der Mitarbeiter von mwauth
          ...
          <li>
            ...
            <p>
              ...
              die betroffene Person jederzeit an einen Mitarbeiter von mwauth
              wenden.
            </p>
          </li>
          <li>
            ...
            <p>
              mwauth verarbeitet die personenbezogenen Daten im Falle des
            ...
            <p>
              Verarbeitet mwauth personenbezogene Daten, um Direktwerbung zu
              ...
              steht. Widerspricht die betroffene Person gegenüber mwauth der
              Verarbeitung für Zwecke der Direktwerbung, so wird mwauth die
            ...
            <p>
              ...
              Verarbeitung personenbezogener Daten, die bei mwauth zu
            ...
            <p>
              ...
              Person direkt an jeden Mitarbeiter von mwauth oder einen anderen
          ...
          <li>
            ...
            <p>
              ...
              ausdrücklicher Einwilligung der betroffenen Person, trifft mwauth
        ...
        <p>
          Art. 6 I lit. a DS-GVO dient mwauth als Rechtsgrundlage für
          ...
          mwauth einer rechtlichen Verpflichtung durch welche eine Verarbeitung
          ...
          6 I lit. c DS-GVO. In seltenen Fällen könnte die Verarbeitung von
          ...
          zur Wahrung eines berechtigten Interesses von mwauth oder eines
        ...
        <p>
          ...
          bereitzustellen, wenn mwauth mit ihr einen Vertrag abschließt. Eine
          Nichtbereitstellung der personenbezogenen Daten hätte zur Folge, dass
          der Vertrag mit dem Betroffenen nicht geschlossen werden könnte. Vor
          einer Bereitstellung personenbezogener Daten durch den Betroffenen
        ...
        <p>
          Aus Verantwortungsbewusstsein verzichten wir auf eine automatische
        ...
        <p>
          ...
          >
            Datenschutz Rechtsanwalt Christian Solmecke
          </a>{" "}
          erstellt.
        </p>
      </div>
